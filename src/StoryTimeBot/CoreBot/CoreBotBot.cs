...
using CoreBot.Dialogs.StorySelection;
...
namespace CoreBot
{
    ...
    public class CoreBotBot : IBot
    {
        ...
        public CoreBotBot(BotServices services, UserState userState, ConversationState conversationState, ILoggerFactory loggerFactory)
        {
            ...
            _storySelectionStateAccessor = _userState.CreateProperty<StorySelectionState>(nameof(StorySelectionState));
            ...
            Dialogs.Add(new StorySelectionDialog(_storySelectionStateAccessor, loggerFactory, api));
        }
                ...
                if (!dc.Context.Responded)
                {
                    ...
                    switch (dialogResult.Status)
                    {
                        case DialogTurnStatus.Empty:
                            ...
                            //        break;
                            //}
                            await dc.BeginDialogAsync(nameof(StorySelectionDialog));
